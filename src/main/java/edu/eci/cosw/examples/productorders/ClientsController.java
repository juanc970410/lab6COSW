...
public class ClientsController {
    ...
    @RequestMapping(path="/value/{cost}", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<List<Cliente>> getVehicleByProductId(@PathVariable("cost") long cost){
        try{
            return ResponseEntity.ok().body(services.getClientsByProductValue(cost));
